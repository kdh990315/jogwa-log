...
import { ChevronsUpDownIcon } from "../icons/chevronsUpDown/chevronsUpDown";
import { CloudIcon } from "../icons/cloud/cloud";
import { CloudRainIcon } from "../icons/cloudRain/cloudRain";
import { CloudSunIcon } from "../icons/cloudSun/cloudSun";
...
import { RegisterLogDialog } from "../dashboard/registerLog/registerLogDialog";
        ...
        {[
          ...
          >
            <div className="flex items-start justify-between gap-2">
              ...
              <div
                className={`shrink-0 rounded-lg p-2 ${item.bg} ${item.color}`}
              >
                {item.icon}
              </div>
            </div>
          ...
          <div className="flex items-center justify-between border-t border-line bg-surface-muted/30 px-4 py-3">
            ...
            {bestDay ? (
              <p className="hidden text-[10px] text-fg-muted sm:block">
                최고 기록:{" "}
                <span className="font-semibold text-fg-dim">
                  {formatShortMonthDay(bestDay.occurredOn)} · {bestDay.count}
                  마리 ({bestDay.species})
                </span>
              </p>
            ) : null}
